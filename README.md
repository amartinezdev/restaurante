...
│   ├── restaurante.sql # estructura y datos principales (antigua)
│   ├── restaurante_02.sql # copia de prueba (antigua)
│   ├── restaurante_03.sql # copia de respaldo (antigua)
|   └── restaurante_04.sql # copia de base de datos actual
...
│   ├── productoServido.php # marca productos como servidos
│   ├── productoServido02.php # versión alternativa de productoServido

        ...
        <div class="collapse navbar-collapse justify-content-center" id="navbarMain">
            <ul class="navbar-nav mb-2 mb-lg-0 text-center">
                ...
                <li class="nav-item mx-3">
                    <a class="nav-link d-flex align-items-center justify-content-center <?php echo $active === 'mesas' ? 'text-secondary' : 'text-light' ?>"
                ...
                <!-- Pedidos -->
                <li class="nav-item mx-3">
                    <a class="nav-link d-flex align-items-center justify-content-center <?php echo $active === 'pedidos' ? 'text-secondary' : 'text-light' ?>"
                        href="<?php echo $navbar2 ?>">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                            fill="currentColor" class="bi bi-cart3 me-2" viewBox="0 0 16 16">

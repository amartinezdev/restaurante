...
<head>
    ...
    <title>El Quinto Pino - Agregar Personal</title>
                ...
                <div class="col-12 col-md-10 col-lg-8 col-xl-6">
                    <section class="bg-dark-subtle border rounded-4 p-3 p-sm-4">
                        <header class="text-center mb-3">
                            <h2 class="display-6">
                                Añadir personal
                                <a href="<?php echo BASE_PATH; ?>/encargado/personal.php" class="link-light float-end"> <svg xmlns="http://www.w3.org/2000/svg" width="35" height="35" fill="currentColor" class="bi bi-arrow-left-circle" viewBox="0 0 16 16">

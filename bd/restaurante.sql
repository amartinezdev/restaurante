...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 06-11-2025 a las 01:32:18
...
(1, 'Agua mineral', 1.5, 100, 1, 1),
(2, 'Coca-Cola', 2, 80, 1, 1),
(3, 'Fanta Naranja', 2, 75, 1, 1),
(4, 'Cerveza', 2.5, 60, 1, 1),
(5, 'Té frío', 1.8, 50, 1, 1),
(6, 'Patatas fritas', 3, 40, 1, 2),
(7, 'Aceitunas', 2.5, 35, 1, 2),
(8, 'Croquetas caseras', 4.5, 30, 1, 2),
(9, 'Calamares a la romana', 5, 25, 1, 2),
(10, 'Pan con alioli', 2, 45, 1, 2),
(11, 'Ensalada mixta', 6, 25, 1, 3),
(12, 'Sopa de verduras', 5.5, 20, 1, 3),
(13, 'Gazpacho', 5, 30, 1, 3),
(14, 'Pasta boloñesa', 7.5, 15, 1, 3),
(15, 'Arroz a la cubana', 7, 18, 1, 3),
(16, 'Pollo al horno', 9, 15, 1, 4),
(17, 'Entrecot de ternera', 14, 10, 1, 4),
(18, 'Salmón a la plancha', 12, 12, 1, 4),
(19, 'Lomo con patatas', 8.5, 20, 1, 4),
(20, 'Hamburguesa completa', 9.5, 25, 1, 4),
(21, 'Flan casero', 3.5, 20, 1, 5),
(22, 'Tarta de queso', 4, 15, 1, 5),
(23, 'Helado de vainilla', 3, 30, 1, 5),
(24, 'Brownie con helado', 4.5, 12, 1, 5),
(25, 'Fruta del tiempo', 2.5, 25, 1, 5),
(26, 'Café solo', 1.2, 100, 1, 6),
(27, 'Café con leche', 1.5, 100, 1, 6),
(28, 'Cappuccino', 2, 50, 1, 6),
(29, 'Café americano', 1.8, 40, 1, 6),
(30, 'Carajillo', 2.2, 30, 1, 6);
...
('1', '1', 'Álvaro', 'Martínez', 2, 'alvaro@gmail.com', 666666666, 'BOMBOCLAT', 0),
('2', '2', 'Camarero', '2', 1, '2@gmail.com', 2, NULL, 0),
('3', '3', 'cliente', '3', 0, '3@gmail.com', 3, NULL, 0);
...
--
ALTER TABLE `producto_pedido`
  ADD CONSTRAINT `producto_pedido_ibfk_1` FOREIGN KEY (`idPedido`) REFERENCES `pedido` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
